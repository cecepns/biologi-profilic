...
import { ChevronRight, Info, Sparkles, Sprout, BookOpen, Layers } from 'lucide-react';
...
export const StudentDashboard = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* Top Hero Section matching the mobile screenshot */}
      ...
      <div className="space-y-3">
        ...
        {/* 5 ProFLiC Stage Cards (Exact match to screenshot) */}
        <ProFLiCStageCards projectId={1} />
      </div>

      {/* Section: Proyek Aktif Card at Bottom (Exact match to screenshot) */}
      <div className="pt-2">
        <ActiveProjectCard
          project={{
            id: 1,
