...
import { BookOpen, Calendar, Users, ArrowRight, CheckCircle2, Clock } from 'lucide-react';
  ...
  const allProjects = [
    {
      ...
      currentStage: 3,
      stageName: 'Collaborative Investigation',
      progress: 60,
    ...
    {
      id: 2,
      title: 'Struktur & Fungsi Sel Tumbuhan dan Hewan',
      topic: 'Biologi Seluler & Transpor Membran',
      className: 'XI IPA 2',
      teacherName: 'Ibu Maya Sartika, M.Pd.',
      cover: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=600',
      currentStage: 1,
      stageName: 'Pre-Class Preparation',
      progress: 20,
    ...
    {
      id: 3,
      title: 'Pola-Pola Hereditas & Rekayasa Genetika',
      topic: 'Genetika & Bioteknologi Modern',
      className: 'XI IPA 2',
      teacherName: 'Ibu Maya Sartika, M.Pd.',
      cover: 'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=600',
      currentStage: 1,
      stageName: 'Pre-Class Preparation',
      progress: 0,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Daftar topik pembelajaran berbasis 5 sintaks model ProFLiC.
          </p>
        </div>
